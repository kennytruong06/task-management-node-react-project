...
const Dashboard = () => {
  ...
  return (
    <>
      <PageTitle>Tổng quan về bảng điều khiển</PageTitle>

      <div className="grid gap-2 mb-8 xl:grid-cols-5 md:grid-cols-2">
        <CardItemTwo
          mode={mode}
          title="Today Order"
          title2="Đơn hàng hôm nay"
          Icon={ImStack}
        ...
        <CardItemTwo
          mode={mode}
          title2="Doanh số bán hàng mọi thời đại"
          Icon={ImCreditCard}
      ...
      <PageTitle>{"Đơn hàng hiện tại"}</PageTitle>
